		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Compra",
									"targetURL": "#chchcomcompra-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"chchcomcompra-display": {
								"semanticObject": "chchcomcompra",
								"action": "display",
								"description": "Compra",
								"title": "Compra",
								"signature": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=chch.com.compra",
									"url": sap.ui.require.toUrl("chch/com/compra")
								}
							}
						}
					}

		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Invoice",
									"targetURL": "#chchesinvoices-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"chchesinvoices-display": {
								"semanticObject": "chchesinvoices",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=chches.invoices",
									"url": sap.ui.require.toUrl("chches/invoices")
								}
							}
						}
					}

		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "TInvoices",
									"targetURL": "#nsinvoicesinvoices-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"nsinvoicesinvoices-display": {
								"semanticObject": "nsinvoicesinvoices",
								"action": "display",
								"description": "DInvoices",
								"title": "TInvoices",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=nainvoices.invoices",
									"url": sap.ui.require.toUrl("nsinvoices/invoices")
								}
							}
						}
					}

		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Venta",
									"targetURL": "#chchcomventa-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"chchcomventa-display": {
								"semanticObject": "chchcomventa",
								"action": "display",
								"description": "Venta",
								"title": "Venta",
								"signature": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=chch.com.venta",
									"url": sap.ui.require.toUrl("chch/com/venta")
								}
							}
						}
					}
